			...
			<div class="row">
				...
				<div class="col-xxl-3 col-md-6">
					...
					<section class="widget top-tabs">
                        <header class="widget-header-dark">Routes</header>
                        ...
                        <button style="margin-top:10px;" class="btn-block btn btn-success">Filter</button>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>Name: Sam Njuguna <br> Car: Fielder <br> Plate: KCB 990 <br> Car Sits : 4 </td>
							...
							<div class="modal-footer">
                                <button type="button" class="btn btn-rounded btn-success">Book Sit</button>
